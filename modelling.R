...
pacman::p_load(tidyverse, outbreaks, bslib, bsicons, shiny, 
               plotly, htmltools, reactable, flexdashboard, gapminder, here,janitor,
               sf,gganimate, countrycode, scales, RColorBrewer, viridis, ggpmisc, ggplot2, 
               deSolve, rmarkdown, tinytex, minpack.lm, igraph, surveillance, sp, reshape2,
               xtable)
